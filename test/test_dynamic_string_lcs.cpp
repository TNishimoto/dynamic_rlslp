...
/**
 * @brief Length of the longest common suffix of strings derived by two explicit nonterminals (naive implementation)
 */
uint64_t naive_lcs(
...
bool lcs_test(bool use_restricted_block_compression, int64_t seed, uint64_t alphabet_type, dynRLSLP::DictionaryMode mode, uint64_t num_trials = 1000, uint64_t max_length = 10000)
{
    ...
    std::cout << "========================================" << std::endl;
    std::cout << "Running DynamicString lcs test" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    std::cout << "  3. For each pair of non-null explicit nonterminals (X1, X2), verify lcs(X1, X2)" << std::endl;
    std::cout << "  4. Verify dynRLSLP::DynamicRLSLPString::lcs(X1, X2) == naive_lcs(X1, X2)" << std::endl;
    std::cout << std::endl;
...
{
    std::cout << "========================================" << std::endl;
    std::cout << "Test for dynRLSLP::DynamicRLSLPString::lcs()" << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << std::endl;
    std::cout << "[Test purpose]" << std::endl;
    std::cout << "For the longest common suffix length of strings derived by explicit nonterminals X1 and X2," << std::endl;
    std::cout << "verify that DynamicRLSLPString::lcs(X1, X2) matches the naive implementation." << std::endl;
    std::cout << std::endl;
